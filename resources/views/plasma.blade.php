  ...
  <body>
    ...
    <nav class="navbar navbar-dark bg-success">
        <div class="container">
          ...
          <div class="d-flex">
            <h6 class="text-white">{{ 'Jimbaran, ' . date('d-M-Y'); }}</h6>
          </div>
        </div>
    </nav>
          ...
          <div class="card bg-dark rounded-0">
              <div class="card-body">
                <marquee behavior="" direction="" class="text-white">
                  <img src="/img/logo.png" width="30" height="30" alt=""> Selamat Datang di Sistem Antrian Layanan USDI Universitas Udayana</marquee>
              </div>
          </div>
      </div>
      </div>
